...
public class EditEmployee extends ThymeleafServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (employeeManager != null) {
			...
			EmployeeModel employeeModel = employeeManager.getEmployeebySSN(ssn);
			if (employeeModel != null) {
				request.setAttribute("employee", employeeModel);
				WebContext ctx = new WebContext(request, response, getServletContext(), request.getLocale());
				
				String templateName = "/editEmployee.html";
			...
			request.setAttribute("errorMessage", "No employee with ssn " + ssn);
			WebContext ctx = new WebContext(request, response, getServletContext(), request.getLocale());
